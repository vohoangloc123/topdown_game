...
public class BossHealth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bossCollider = GetComponent<BoxCollider2D>(); // Gán giá trị cho enemyCollider
    ...
    public void ControlMovementPause(bool pause)
    {
        ...
        {
            bossMovement.PauseMovement(pause); // Gọi phương thức PauseMovement từ EnemyMovement
        }
        if (bossCollider != null)
        {
            bossCollider.enabled = !pause; // Ẩn collider
        }
